...
const ModalDelete = ({ isVisible, onClose, data, updatePage }) => {
  ...
  function handleSubmit(event) {
    ...
    Axios({
      ...
      url: "http://localhost:1993/api/delete_candidate",
      data: inputData,
  ...
  return (
    <>
      <div className="overflow-y-auto overflow-x-hidden fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex z-50  justify-center items-center">
