...
const ModalEdit = ({ isVisible, onClose, data, updatePage }) => {
  ...
  function handleSubmit(event) {
    ...
    Axios({
      ...
      url: "http://localhost:1993/api/edit_candidate",
      data: inputData,
              ...
              <div className="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    name="id"
                    id="id"
                    className="hidden bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 "
                    onChange={(event) =>
